 ...
 <>
      ...
      <div className=" mx-4 my-3 " >
            <div class="serviceBox_2 my-4 mx-3" style={{height:'20rem'}}>
                <div class="service-icon_2 d-flex justify-content-center align-items-center"><a href={props.link} target='_blank'> <BsBoxArrowInUpRight fontSize={25}  color="black"></BsBoxArrowInUpRight></a></div>
                ...
                <img src={props.s} height={170} style={{width:"100%", borderRadius:"10px"}}></img>
                    ...
                    <button class="read-more p-0 my-3" role="button"><a href={props.gitlink} target='_blank'>Source Code <PiGithubLogoFill color="white" fontSize={25}></PiGithubLogoFill></a></button>
                    </div>
                </div>
            </div>
            </div>
